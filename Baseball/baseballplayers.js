...
getPlayers = (year) => {
    ...
    url = 'https://api.mysportsfeeds.com/v1.2/pull/mlb/' + year + '-regular/roster_players.json?team='+ team + '&sort=player.lastname.A';
    var playerArray = [];
    fetch(url, {
        headers: {
...
getPlayerInfo = (year) => {
    var team = getGetValue();
    url = 'https://api.mysportsfeeds.com/v1.2/pull/mlb/' + year + '-regular/cumulative_players.json?team='+ team + '&sort=player.lastname.A';
    var playerArray = [];
    fetch(url, {
        headers: {
            'Authorization': 'Basic '+btoa('ggallegos:software'), 
